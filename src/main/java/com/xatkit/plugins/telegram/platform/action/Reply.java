...
/**
 * A {@link RuntimeMessageAction} that replies to a message using the input telegram channel.
 * <p>
 * This action relies on the provided {@link StateContext} to retrieve the {@code channel} associated to the user
 * input (i.e. the chatId identifier).
 *
 * @see PostMessage
 */
public class Reply extends PostMessage {
     ...
     *
     * @param platform the {@link com.xatkit.plugins.telegram.platform.TelegramPlatform} containing this action
     * @param context  the {@link StateContext} associated to this action
     * @param message  the message to post
     */
    public Reply(@NonNull TelegramPlatform platform, @NonNull StateContext context, @NonNull String message) {
     ...
     * @throws NullPointerException     if the provided {@code platform} or {@code context} is {@code null}
